 ...
 */
public class Alert2 implements AbsoluteWrapperContainer {
    ...
    public Alert2(Wrapper _wrapper) {
    ...
    public Alert2 type(AlertType _alertType) {
        this.alertType = _alertType;
        return this;
    }

    public Alert2 title(String _title) {
        this.title = _title;
        return this;
    }

    public Alert2 text(String _text) {
        this.text = _text;
        return this;
    }
    ...
    public void show() {
        ...
        if (text == null || text.isEmpty()) {
            try {
                throw new Exception("Error : Alert2 needs a text information.");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
...
//        container.getStyleClass().add(color.replace("-", ""));
    ...
    @Override
    public AbsoluteWrapperContainer pos(Pos pos) {
        return null;
    }
}
