...
public class SimpleLoadCircle extends StackPane {
    ...
    public SimpleLoadCircle() {
        ...
        one.setStyle("-fx-stroke-dash-offset : 30; -fx-stroke-dash-array : 50; -fx-stroke :  derive(-fx-accent, 50%);");
        two.setStyle("-fx-stroke-dash-array : 30; -fx-stroke : derive(-fx-accent, 30%);");
