...
//        Preferences prefs = java.util.prefs.Preferences.userNodeForPackage(MainScene.class);
        java.util.prefs.Preferences prefs = java.util.prefs.Preferences.userNodeForPackage(MainScene.class);
